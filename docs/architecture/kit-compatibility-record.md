...
|---|---|---|---|---|
| `dreamlab-ai.com` (+ mirror `thedreamlab.uk`) | `c978a239e6523bb009c2ea8e3b8a165f049b3d43` | `soak-fix-sprint-2026-07` (proactive NIP-44 capability banner on the DM page for NIP-07 sessions that can't read encrypted DMs) | `integrated` | ✔ |

<!-- pin-check:canonical-kit-sha -->
```
CANONICAL_KIT_SHA=c978a239e6523bb009c2ea8e3b8a165f049b3d43
