...
|---|---|---|---|---|
| `dreamlab-ai.com` (+ mirror `thedreamlab.uk`) | `672b7c36bcef8a5c9f297523ec8986f7e1d7ffda` | `main` (tag `soak-fix-2026-07-23` — the soak-fix sprint merged back to trunk; app crates now `publish = false`, libraries unchanged at `1.0.0-beta.6`) | `integrated` | ✔ |

<!-- pin-check:canonical-kit-sha -->
```
CANONICAL_KIT_SHA=672b7c36bcef8a5c9f297523ec8986f7e1d7ffda
