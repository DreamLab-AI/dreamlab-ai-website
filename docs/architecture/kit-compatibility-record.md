...
|---|---|---|---|---|
| `dreamlab-ai.com` (+ mirror `thedreamlab.uk`) | `83511bb5620c78e36bf104b4b7e5decea3864a35` | `main` (tag `v1.0.0-beta.8` — kit release adopting solid-pod-rs `0.5.0-alpha.7` / did:nostr CG spec 0.1.1 three-context `@context`, plus the `nostr 0.44.6` yanked-range escape; six library crates published to crates.io at `1.0.0-beta.8`, `beta.7` yanked) | `integrated` | ✔ |

<!-- pin-check:canonical-kit-sha -->
```
CANONICAL_KIT_SHA=83511bb5620c78e36bf104b4b7e5decea3864a35
