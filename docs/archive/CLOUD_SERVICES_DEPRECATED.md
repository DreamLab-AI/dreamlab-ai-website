---
status: DEPRECATED
superseded-by: ../deployment/CLOUDFLARE_WORKERS.md
date: 2026-03-07
---

> **DEPRECATED**: This document describes GCP Cloud Run services which were **deleted on 2026-03-02**.
> The current backend runs entirely on Cloudflare Workers.
> See [CLOUDFLARE_WORKERS.md](../deployment/CLOUDFLARE_WORKERS.md) for the current documentation.

# Cloud Services Deployment

**Last Updated:** 2026-03-02

> **DEPRECATED (2026-03-02):** All GCP Cloud Run services have been deleted. The platform now runs entirely on Cloudflare Workers. See [CLOUDFLARE_WORKERS.md](../deployment/CLOUDFLARE_WORKERS.md) for the current backend architecture.
>
