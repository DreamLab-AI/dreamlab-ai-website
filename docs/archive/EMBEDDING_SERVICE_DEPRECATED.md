---
status: DEPRECATED
superseded-by: ../api/SEARCH_API.md
date: 2026-03-07
---

> **DEPRECATED**: This document describes the GCP Cloud Run embedding service which was **deleted on 2026-03-02**.
> The current implementation uses the Cloudflare Worker `search-api` with RuVector WASM.
> See [SEARCH_API.md](../api/SEARCH_API.md) for the current documentation.
...
- [Nostr Relay API](../api/NOSTR_RELAY.md) -- Source events for embeddings
