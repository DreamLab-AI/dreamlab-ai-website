...
- `community-forum` (since removed; superseded by the upstream [nostr-rust-forum](https://github.com/DreamLab-AI/nostr-rust-forum) kit) application migration strategy
