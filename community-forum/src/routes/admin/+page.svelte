...
<div class="container mx-auto p-4 max-w-6xl">
  ...
  {#if $authStore.isNip07 && !authStore.getPrivkey()}
    <div class="alert alert-info mb-4">
      ...
      <span>NIP-07 login detected. Admin operations will use your browser extension to sign NIP-98 auth tokens — you may see a signing prompt for each action.</span>
    </div>
  {/if}
