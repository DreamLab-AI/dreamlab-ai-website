...
const ResidentialTraining = () => {
  ...
  // Residential training programmes — multi-instructor delivery with premium residential experience
      ...
      <section className="bg-gradient-to-r from-amber-500/10 via-amber-500/5 to-amber-500/10 border-b border-amber-500/20">
        <div className="container py-3 px-4">
          <p className="text-center text-sm text-amber-200/90">
            <span className="font-semibold">Spaces are limited</span> — get in touch to check availability for upcoming sessions
          </p>
        </div>
      </section>
