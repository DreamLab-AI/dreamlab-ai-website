...
//!
//! The legacy `dreamlab:onboarded` localStorage key is still honoured so
...
const LEGACY_ONBOARDED_KEY: &str = "dreamlab:onboarded";
...
const NIP05_HOST: &str = "dreamlab-ai.com";
