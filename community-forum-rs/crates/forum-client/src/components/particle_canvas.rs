...
//! - **DreamLab** hero: node-edge constellation, ethereal sparkle
...
/// Blue-300: cool accent (~15 % of particles). Nods to minimoonoir ice-blue
/// and dreamlab cyan without overwhelming the amber theme.
