...
pub fn auth_api_base() -> String {
    ...
    option_env!("VITE_AUTH_API_URL")
        .unwrap_or("https://api.dreamlab-ai.com")
        .to_string()
}
...
mod tests {
    ...
    fn ws_to_http_production_url() {
        assert_eq!(
            ws_to_http("wss://dreamlab-nostr-relay.solitary-paper-764d.workers.dev"),
            "https://dreamlab-nostr-relay.solitary-paper-764d.workers.dev"
        );
    }
